...
SETTINGS_com_balls = {'img_fn': com_balls, 'threshold':87, 'invert':True, 'blur_kernel':3}
...
SETTINGS_com_bubble = {'img_fn': com_bubble, 'threshold':87, 'invert':True, 'blur_kernel':3}
...
def measure_com(cam, shaker, pts, settings=None, debug=False):
    ...
    # take image and analyse to find centre of mass of system
    img = cam.get_frame()
    x0, y0=settings['img_fn'](img, pts, img_settings=img_processing, debug=debug)
