...
class Balancer:
    ...
    def level(self, measure_fn, dimensions : List[Tuple[int, int]]=None, use_pts=None, use_costs=None, initial_iterations=10, ncalls=50, tolerance=2):
        ...
        result_gp = gp_minimize(min_fn, dimensions, x0=generate_initial_pts(use_pts), y0=generate_initial_costs(use_costs), n_initial_points=15, n_calls=ncalls, acq_optimizer="sampling", verbose=True)
